...
class Ajax {
  ...
  setCurrentUser(userId, userName) {
    return Vue.http.post(
      ...
      `https://snacktrackapi.herokuapp.com/api/v1/users.json`,
  ...
  fetchRecipes(ingredients) {
    return Vue.http.get(
      // 'http://localhost:3000/api/v1/recipes.json',
      `https://snacktrackapi.herokuapp.com/api/v1/recipes.json`,
  ...
  getRecipe(id) {
    return Vue.http.get(
      ...
      `https://snacktrackapi.herokuapp.com/api/v1/recipes/${id}.json`
    )
  }
}
